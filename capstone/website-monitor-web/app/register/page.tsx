  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0B0E14] px-4">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-2xl font-semibold text-[#E7EAF0] mb-1 tracking-tight">Create account</h1>
        <p className="text-sm text-[#8A93A6] mb-6">Start watching the web for what matters.</p>
        ...
        <p className="text-sm text-[#8A93A6] mt-6">
          Already have one? <Link href="/login" className="text-[#F5A623] hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
